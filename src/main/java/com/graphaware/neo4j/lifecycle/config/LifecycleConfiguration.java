...
public class LifecycleConfiguration extends BaseTxAndTimerDrivenModuleConfiguration<LifecycleConfiguration> {
	...
	public LifecycleStrategy<Relationship> getRelationshipExpirationStrategy() {
		return relationshipExpirationStrategy;
	}

	public LifecycleStrategy<Node> getNodeRevivalStrategy() {
		return nodeRevivalStrategy;
	}

	public LifecycleStrategy<Relationship> getRelationshipRevivalStrategy() {
	 ...
	 * @return
	 */
	public List<LifecycleEvent> buildEvents() {
		cleanup();
		...
		if (nodeRevivalIndex != null || relationshipRevivalIndex != null) {
			events.add(new RevivalEvent(getNodeRevivalProperty(), getRelationshipRevivalProperty(), getRevivalOffset(), getNodeRevivalIndex(), getRelationshipRevivalIndex(), getNodeRevivalStrategy(), getRelationshipRevivalStrategy()));
		}

		events.forEach(LifecycleEvent::validate);
