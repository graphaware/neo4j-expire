...
public interface LifecycleIndexer {
	 ...
	 * @param node to index.
	 */
	void indexNode(LifecycleEvent event, Node node);
	 ...
	 */
	void indexRelationship(LifecycleEvent event, Relationship relationship);
	 ...
	 */
	IndexHits<Node> nodesEligibleFor(LifecycleEvent event, long timestamp);
	 ...
	 */
	IndexHits<Relationship> relationshipsEligibleFor(LifecycleEvent event, long timestamp);
	 ...
	 */
	void removeNode(LifecycleEvent event, Node node);
	 ...
	 */
	void removeRelationship(LifecycleEvent event, Relationship relationship);
