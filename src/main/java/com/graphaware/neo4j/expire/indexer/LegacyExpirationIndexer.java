    ...
    private Long getExpirationDate(PropertyContainer pc, String expirationProperty, String ttlProperty) {
        ...
        if (pc.hasProperty(expirationProperty)) {
            try {
                ...
                LOG.warn("{} expiration property is non-numeric: {}", pc, pc.getProperty(expirationProperty));
            }
        }
        ...
        if (pc.hasProperty(ttlProperty)) {
            try {
                ...
                if (result != null) {
                    LOG.warn("{} has both expiry date and a ttl.", pc);
                ...
                LOG.warn("{} ttl property is non-numeric: {}", pc, pc.getProperty(ttlProperty));
            }
        }
